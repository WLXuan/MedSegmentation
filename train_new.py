...
parser.add_argument('--root_path', type=str,
                    default='./data/my_Synapse/train_npz', help='root dir for data')
parser.add_argument('--dataset', type=str,
                    default='Synapse', help='experiment_name')
parser.add_argument('--list_dir', type=str,
                    default='./lists/my_lists_Synapse', help='list dir')
...
parser.add_argument('--vit_name', type=str,
                    default='ViT-B_16', help='select one vit models')
...
if __name__ == "__main__":
    ...
    dataset_config = {
        'Synapse': {
            'root_path': './data/my_Synapse/train_npz',
            'list_dir': './lists/my_lists_Synapse',
            'num_classes': 2,
        },
    }
    ...
    args.exp = 'myTransU_' + dataset_name + str(args.img_size)
    ...
    pretrained_path = './models/vit_checkpoint/imagenet21k/ViT-B_16.npz'
