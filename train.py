...
parser.add_argument('--vit_name', type=str,
                    default='R50-ViT-B_16', help='select one vit models')  # R50-ViT-B_16
...
if __name__ == "__main__":
    ...
    args.exp = 'KaggleEndovis1TransU_' + dataset_name + str(args.img_size)
    snapshot_path = "./models/{}/{}".format(args.exp, 'AddTU')
    ...
    pretrained_path = './models/vit_checkpoint/imagenet21k/R50+ViT-B_16.npz'
