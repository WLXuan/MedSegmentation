...
def test_single_image(image, net, classes, patch_size=[256, 256], test_save_path=None, case=None, z_spacing=1):
    print(type(image))
    x = image.shape[0]
    y = image.shape[1]
    ...
    for i in range(1, classes):
        metric_list.append(calculate_metric_percase(prediction == i))
